...
class UpdateFurniture extends React.Component {
  ...
  componentDidMount() {
    ...
    axios
      .get(
        `http://localhost:8080//api/showFurniture/getFurnitureDetalis/${this.props.match.params.furnitureId}`
      )
  ...
  handleSubmit = (event) => {
    ...
    axios
      .put(
        `http://localhost:8080//api/showFurniture/updateFurniture/${this.props.match.params.furnitureId}`,
